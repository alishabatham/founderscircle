    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-24 px-6 bg-white border-b border-border">
        <div className="max-w-5xl mx-auto">
          <motion.h2 {...sectionProps} className="text-3xl font-bold text-gray-900 mb-12 text-center">Entry Process</motion.h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <motion.div key={i} {...sectionProps} transition={{ ...sectionProps.transition, delay: i * 0.1 }} className="p-6 border border-border bg-slate-50 shadow-sm relative">
      ...
      <section className="py-24 px-6 bg-gray-50 border-b border-border">
        <div className="max-w-5xl mx-auto">
          <motion.h2 {...sectionProps} className="text-3xl font-bold text-gray-900 mb-12 text-center">Execution System Stages</motion.h2>
          <div className="flex flex-col md:flex-row gap-4">
            {[
              ...
              <motion.div key={i} {...sectionProps} transition={{ ...sectionProps.transition, delay: i * 0.1 }} className="flex-1 p-6 border border-primary/20 bg-white shadow-sm text-center">
      ...
      <section className="py-24 px-6 bg-white border-b border-border">
        <div className="max-w-4xl mx-auto">
          <motion.h2 {...sectionProps} className="text-3xl font-bold text-gray-900 mb-12 text-center">Progress Tracking</motion.h2>
      ...
      <section className="py-24 px-6 bg-gray-50 border-b border-border">
        <div className="max-w-5xl mx-auto">
          <motion.h2 {...sectionProps} className="text-3xl font-bold text-gray-900 mb-12 text-center">Collaboration</motion.h2>
          <div className="grid md:grid-cols-3 gap-6 text-center">
            {[
              ...
              <motion.div key={i} {...sectionProps} transition={{ ...sectionProps.transition, delay: i * 0.1 }} className="p-8 border border-border bg-white shadow-sm">
      ...
      <section className="py-24 px-6 bg-white border-b border-border">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h2 {...sectionProps} className="text-3xl font-bold text-gray-900 mb-12">Support System</motion.h2>
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              <motion.div key={i} {...sectionProps} transition={{ ...sectionProps.transition, delay: i * 0.1 }} className="p-6 border border-border bg-slate-50 flex flex-col items-center justify-center gap-3 shadow-sm">
      ...
      {/* 7. Flow Summary */}
      <section className="py-32 px-6 bg-gray-900 text-white border-b border-border">
      ...
      <section className="py-24 px-6 bg-white text-center">
        <motion.div {...sectionProps} className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Ready to enter the system?</h2>

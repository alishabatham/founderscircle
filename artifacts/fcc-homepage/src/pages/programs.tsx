    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-24 px-6 bg-background border-b border-border">
        <div className="max-w-6xl mx-auto">
          <motion.h2 {...sectionProps} className="text-3xl font-bold text-foreground mb-12 text-center">What You Get</motion.h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={i} {...sectionProps} transition={{ ...sectionProps.transition, delay: i * 0.1 }} className="p-6 bg-card border border-border shadow-sm">
      ...
      <section className="py-24 px-6 bg-card border-b border-border">
        <div className="max-w-4xl mx-auto">
          <motion.h2 {...sectionProps} className="text-3xl font-bold text-foreground mb-12 text-center">How It Works</motion.h2>
      ...
      <section className="py-24 px-6 bg-background border-b border-border">
        <div className="max-w-5xl mx-auto text-center">
          <motion.h2 {...sectionProps} className="text-3xl font-bold text-foreground mb-12">Outcomes</motion.h2>
          <div className="flex flex-wrap justify-center gap-4">
            {["Faster execution", "Clear direction", "Better decision-making", "Access to serious founders", "Real progress, not just learning"].map((benefit, i) => (
              <motion.div key={i} {...sectionProps} transition={{ ...sectionProps.transition, delay: i * 0.1 }} className="px-6 py-3 bg-card border border-border rounded-full shadow-sm font-medium text-foreground">
                {benefit}
              </motion.div>
            ))}
          </div>

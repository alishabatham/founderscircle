...
export default function HomePage() {
  return (
    <div className="min-h-screen w-full bg-background text-foreground overflow-x-hidden">
      {/* Hero */}
      <section className="relative min-h-[88vh] flex items-center border-b border-border bg-white">
        <div className="container max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center pt-20 pb-16">
          <div className="flex flex-col items-start text-left md:pr-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-xs text-primary mb-8 font-semibold tracking-wider uppercase">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Button asChild size="lg" className="h-14 px-8 text-base font-medium rounded-none" data-testid="hero-cta-apply">
                <Link href="/apply">
                  Apply for the Next Cohort <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="h-14 px-8 text-base font-medium rounded-none" data-testid="hero-cta-learn">
          ...
          <div className="hidden md:flex justify-center items-center h-full w-full">
            <svg viewBox="0 0 400 400" className="w-full max-w-[460px] h-auto drop-shadow-sm" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
                  <path d="M 40 0 L 0 0 0 40" fill="none" stroke="hsl(var(--border))" strokeWidth="1" strokeDasharray="4 4" />
                </pattern>
              </defs>
              ...
              <circle cx="80" cy="200" r="8" fill="hsl(var(--muted))" stroke="hsl(var(--border))" strokeWidth="2" />
      ...
      <section className="py-24 md:py-32 border-b border-border bg-card">
        <div className="container max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-16 items-start">
            ...
            <div className="md:col-span-5 grid grid-cols-2 gap-4 md:gap-6 mt-8 md:mt-0">
              {[
                ...
                <div key={i} className="relative overflow-hidden p-6 bg-white border border-border shadow-sm hover:shadow-md transition-shadow group">
                  <div className="absolute -right-4 -bottom-6 text-7xl font-black text-foreground/5 pointer-events-none">{item.num}</div>
        ...
        <div className="container max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 items-start">
            {[
              ...
              { title: "Wrong Network", desc: "Surrounded by wantrepreneurs instead of serious builders holding you to a standard.", mt: "md:mt-24" }
            ].map((problem, i) => (
              <div key={i} className={`p-8 bg-white border border-border border-l-4 border-l-destructive shadow-sm ${problem.mt}`}>
      ...
      <section className="py-24 md:py-32 border-b border-border bg-card overflow-hidden">
        <div className="container max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-16 items-center">
            <div className="md:col-span-5 relative py-8 pl-4">
            ...
            <div className="md:col-span-7">
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-12 leading-tight">The FCC execution system.</h2>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 relative z-10">
              {[
                ...
                <div key={i} className="relative bg-white p-8 border border-border shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                  <div className="absolute -top-4 -right-2 text-8xl font-black text-foreground/5 pointer-events-none z-0 select-none">
                    {step.step}
                  </div>
            ...
            <div className="md:col-span-7">
              ...
              <div className="space-y-2">
                ...
                {["Founders building real startups with a bias toward action", "People ready to execute and be held accountable", "Individuals who want structure, not cheerleading"].map((item, i) => (
                  <div key={i} className="flex items-start gap-4 p-4 hover:bg-white transition-colors border-b border-border/50">
      ...
      <section className="py-24 md:py-32 bg-white border-b border-border">
        <div className="container max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-0 bg-card p-8 md:p-12 border border-border shadow-sm">
            ...
            <div className="hidden md:block w-px h-24 bg-border" />
            <div className="flex flex-col">
              <div className="text-5xl font-black text-primary/80 mb-3 tracking-tighter">Absolute</div>
      ...
      {/* Footer */}
      <footer className="pt-24 pb-12 bg-card border-t border-border">
        <div className="container max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 mb-24 items-end">
            ...
            <div className="flex flex-col items-start md:items-end text-left md:text-right">
              ...
              <Button asChild size="lg" className="h-16 px-10 text-lg font-bold rounded-none w-full md:w-auto shadow-sm" data-testid="footer-cta-apply">
